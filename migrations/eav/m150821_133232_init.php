...
class m150821_133232_init extends Migration
{
    ...
    {
        $this->tables = [
            'entity' => "{{%catalog.eav_entity}}",
            'attribute' => "{{%catalog.eav_attribute}}",
            'attribute_type' => "{{%catalog.eav_attribute_type}}",
            'value' => "{{%catalog.eav_attribute_value}}",
            'option' => "{{%catalog.eav_attribute_option}}",
        ];
